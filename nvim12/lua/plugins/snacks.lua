...
vim.keymap.set('n', 'g0', Snacks.picker.lsp_symbols, { desc = 'snacks: lsp symbols' })
...
vim.keymap.set('n', '<leader>fg', Snacks.picker.git_grep, { desc = 'repo grep' })
vim.keymap.set('n', '<leader>fG', Snacks.picker.git_files, { desc = 'repo files' })
