...
-- vim.o.modeline = false -- 'modeline' 'ml' (default on (off for root))
-- vim.o.modelineexpr = false -- 'modelineexpr' 'mle' (default off)
...
vim.o.scrolloff = 2 -- d: 0, lines of context, minimal number of screen lines to keep above and below the cursor.
vim.o.sidescrolloff = 0 -- d: 0, cols of context, minimal number of screen columns to keep to the left and right of the cursor.
vim.o.jumpoptions = 'clean,view' -- d: clean. clean: drop unloaded buffers from jumplist; view: restore scroll position on <C-o>/<C-i>
...
vim.o.foldlevel = 99 -- disable vim's auto-folding
vim.o.foldlevelstart = 99 -- disable vim's auto-folding
