    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('grD', require('snacks.picker').lsp_declarations, 'goto declaration') -- in c, this is the header file
          ...
          -- Extra keymaps for same as above
          map('<leader>ca', vim.lsp.buf.code_action, 'code actions', { 'n', 'x' }) -- `gra`
