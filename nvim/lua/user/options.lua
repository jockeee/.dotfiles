...
opt.showtabline = 2 -- default: 1, 0=never, 1=only if there are at least two tab pages, 2=always
-- opt.guicursor:append 't:blinkon0' -- disable cursor blinking, it's too beautiful... hypnotic. aargh you love it
...
opt.sessionoptions = 'buffers,curdir,folds,tabpages,winsize,winpos' -- removed blank, help, terminal, localoptions
