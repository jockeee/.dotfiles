...
-- Mouse
vim.o.mouse = 'a'
vim.o.mousemodel = 'extend' -- default: popup_setpos
...
vim.o.inccommand = 'split' -- default: nosplit, preview substitutions live as you type
vim.o.signcolumn = 'yes' -- always show sign column
vim.o.showmode = false -- show current mode (insert, normal, visual, etc) in bottom bar
vim.o.showcmd = false -- show command in bottom bar -- default: on
vim.o.showtabline = 1 -- default: 1, 0=never, 1=only if there are at least two tab pages, 2=always
vim.o.tabline = '%!v:lua.User.Tabline()'
...
vim.o.scrolloff = 10 -- lines of context, minimal number of screen lines to keep above and below the cursor.
vim.o.sidescrolloff = 20 -- columns of context, minimal number of screen columns to keep to the left and to the right of the cursor.
...
vim.o.hlsearch = true -- highlight search results -- default: on
...
vim.o.splitright = true -- put new windows right of current -- default: off
vim.o.splitbelow = true -- put new windows below current -- default: off
...
vim.o.timeoutlen = 1000 -- default: 1000, time in milliseconds to wait for a mapped sequence to complete
