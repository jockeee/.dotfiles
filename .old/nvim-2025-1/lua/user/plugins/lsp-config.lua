...
-- nvim. This is where `mason` and related plugins come into play.
--
...
return {
  ...
  dependencies = {
    ...
    -- Package manager for nvim that runs everywhere nvim runs.
    ...
    -- lazydev configures Lua LSP for your nvim config, runtime and plugins
  ...
  config = function()
    ...
    --  By default, nvim doesn't support everything that is in the LSP Specification.
    --  When you add nvim-cmp, luasnip, etc. nvim now has *more* capabilities.
    ...
    -- You can add other tools here that you want Mason to install for you, so that they are available from within nvim.
