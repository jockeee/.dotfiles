  ...
  config = function()
    ...
    aerial.setup {
      ...
      layout = {
        ...
        default_direction = 'float', -- Default: prefer_right
        ...
        resize_to_content = true, -- Default: true

        -- Preserve window size equality with (:h CTRL-W_=)
        preserve_equality = false, -- Default: false
      },

      -- Determines how the aerial window decides which buffer to display symbols for
      --   window - aerial window will display symbols for the buffer in the window from which it was opened
      --   global - aerial window will display symbols for the current window
      attach_mode = 'global', -- Default: window
      ...
      highlight_on_jump = 300, -- Default: 300
